...
$total_pd_users = 0;
$total_admin_users = 0;
$total_p_department_users = 0;

// Query to count users by role
$roles = ['pd', 'admin', 'p_department'];
...
foreach ($roles as $role) {
    ...
    if ($role === 'pd') {
        $total_pd_users = $count;
    } elseif ($role === 'admin') {
        $total_admin_users = $count;
    } elseif ($role === 'p_department') {
        $total_p_department_users = $count;
    }
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Total PD Users</h5>
                    <p class="card-text"><?php echo $total_pd_users; ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Total P Department Users</h5>
                    <p class="card-text"><?php echo $total_p_department_users; ?></p>
                </div>
            </div>
        </div>
    </div>
