...
// Assuming $_POST['product_id'] contains the product ID the user wants to add
...
// Fetch priority packages from the database
$query = "SELECT id, name, description, price FROM products WHERE category = 'priorities'"; // Adjust this query as necessary
...
<div class="container">
    <h5>Priority Packages</h5>
    <div class="row">
        <?php if (empty($priorityPackages)): ?>
            <div class="col-12">
                <p>No priority packages available.</p>
            </div>
        <?php else: ?>
            <?php foreach ($priorityPackages as $package): ?>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
    ...
    <!-- Button to redirect to memberships.php -->
