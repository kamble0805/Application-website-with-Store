...
// Handle form submission for updating the user role
    ...
    <form action="" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="role" name="role" required>
                <option value="ems" <?php if ($user['role'] == 'ems') echo 'selected'; ?>>EMS</option>
                <option value="e_department" <?php if ($user['role'] == 'e_department') echo 'selected'; ?>>E Department</option>
            </select>
        </div>
